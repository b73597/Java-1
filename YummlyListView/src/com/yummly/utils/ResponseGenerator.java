	...
	public JSONObject getJSONFromUrl(String url) {
		...
		try {
			...
			HttpURLConnection conn = (HttpURLConnection) yummlyApiUrl
					.openConnection();
			// Check the status code of the response to proceed further
			// Above API call returns 200 OK STATUS with the response. (Yummly Documentation)
			...
			// Close streams in java to avoid unwanted
			// resource usages
			rd.close();
			conn.disconnect();
